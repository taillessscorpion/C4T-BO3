...
while True:
    li = randint(0,24)
    if li != le and li != lk1 and li != lp and li != lw1 and li != lk2 and li != lw2 and li != lm:
        break
maps[le] = 'E'
maps[lk1] = 'K'
maps[lk2] = 'K'
...
while True:
    if lp == le:
        ...
        lucky = randint(1, 3)
        if lucky == 1:
            characters[1]['items'].append('Health')
            print("You've just picked up the Health item")
        elif lucky == 2:
            characters[1]['items'].append('Damage Increase')
            print("You've just picked up the Damage Increase item")
        elif lucky == 3:
            characters[1]['items'].append('Defense Increase')
            print("You've just picked up the Defense Increase item")
        li = 'done'
    elif lp == lk1:
